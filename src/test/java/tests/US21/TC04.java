...
public class TC04 extends TestBaseRapor {
    ...
    public void test1() throws InterruptedException {
        ...
        extentTest=extentReports.createTest("US21 Ürün satış raporlarının incelenmesi",
                "TC_004_Vendor kullanıcı Store manager olarak  satis raporlarını 'son 7 gün' tablosu olarak görüntüleyebilmeli");
        ...
        reportsReviewsPages.reportsLastDaysButton.click();
        ...
        extentTest.pass("Vendor kullanıcı Store manager olarak  satis raporlarını 'son 7 gün' tablosu olarak görüntüleyebildi");
