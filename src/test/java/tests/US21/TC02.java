...
public class TC02 extends TestBaseRapor {
    ...
    public void test1() throws InterruptedException {
        ...
        extentTest=extentReports.createTest("US21 Ürün satış raporlarının incelenmesi",
                "TC_002_Vendor kullanıcı Store manager  olarak satis raporlarını son ay tablosu olarak görüntüleyebilmeli");
        ...
        reportsReviewsPages.reportsLastMonthButton.click();
        ...
        extentTest.pass("Vendor kullanıcı Store manager  olarak satis raporlarını son ay tablosu olarak görüntüleyebildi");
