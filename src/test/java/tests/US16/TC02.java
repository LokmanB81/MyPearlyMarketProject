...
public class TC02 extends TestBaseRapor {
    ...
    @Test
    public void userStory16testcase02() throws InterruptedException {
        ...
        // pdf formatinda indirilmesi dogrulanir
        String homePath = System.getProperty("user.home");
        String pdfFilePath = homePath + "\\Downloads\\Store Manager - Pearly Market.pdf";

        jse.executeScript("arguments[0].click();", customerPage.customerDataPdfDownload);

        Thread.sleep(2000);

        Assert.assertTrue(Files.exists(Paths.get(pdfFilePath)));

        extentTest.pass("Manage customers sayfasinda kayitli kisilerin tum bilgileri pdf formatında indirilebildigi dogrulandi");
